...
<html lang="en">
    ...
    <div class="container">
        <div class="left-side">
            ...
            <p class="text">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed auctor tincidunt aliquam. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas.</p>
            <a href="../Appointment/appointment.html"><button class="oval-button">CREATE APPOINTMENTS</button></a>
            <a href="../User_Visit/uservisit.html"><button class="oval-button">SEE APPOINTMENTS</button></a>
        </div>
