...
INSERT INTO `appointments` (`appointment_id`, `person_id`, `firstname`, `lastname`, `relationship`, `visit_nature`, `photo`, `source_of_income`, `date`, `estimated_time`) VALUES
(24, 9, 'gigel', 'frone', 'relative', 'friendship', 0x433a5c78616d70705c746d705c706870363830382e746d70, 'self-employed', '2023-05-11', '1'),
(25, 9, 'gigel', 'frone', 'relative', 'lawyership', 0x433a5c78616d70705c746d705c706870343945302e746d70, 'self-employed', '2023-05-16', '0');
...
(9, 'stefan123', '$2y$10$Q/Eyg0VgTOS0NfQ6kReYk.DXp8IQEIIofdpTnvVHxIPP.ibX/bBMa', 'stefan', 'adrian', '8sad@gmail.com', NULL, '7stefansdsadrian@gmail.com', 'user'),
...
INSERT INTO `visits_summary` (`visit_id`, `visitor_id`, `inmate_id`, `visit_date`, `visit_type`, `visit_nature`, `items_provided_to_convict`, `items_offered_by_convict`, `health_status`, `visit_start`, `visit_end`, `summary`, `appointment_refID`) VALUES
(14, 9, 1, '2023-05-01', 'friendship', 'Friendship', 'asdasd', 'asd', 'good', '17:03:00', '17:17:00', 'asdasd', 24),
(15, 9, 1, '2023-05-01', 'lawyership', 'Friendship', 'adasd', 'zdd', 'ok', '17:00:00', '17:34:00', 'asdasd', 25);
